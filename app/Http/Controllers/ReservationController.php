    ...
    public function fixPackagesSelection(Request $request)
{
    ...
    $request->validate([
        ...
        'accommodation_id' => 'nullable|exists:accomodations,id', // Ensure valid accommodation
    ]);
...
public function savePackageSelection(Request $request)
{
    ...
    $reservationDetails->accommodation_id = $request->input('accommodation_id'); // New field
    $reservationDetails->activities_id = $request->input('activities_id'); // New field
