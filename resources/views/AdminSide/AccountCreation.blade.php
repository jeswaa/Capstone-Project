...
<<<<<<< HEAD
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h1 class="text-uppercase" style="font-family: 'Anton', sans-serif; color: #0b573d;">Account Creation
                </h1>
...
>>>>>>> e7feac40c7fb2d9dcc6a9eec3e7fbbf774d09206
            ...
            <div class="d-flex justify-content-center mb-5">
                <a href="{{ route('activityLogs') }}" class="text-color-2 text-decoration-none me-5 fancy-link "
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    <h1 class="fs-1 text-uppercase">Activity Logs</h1>
                </a>
                <a href="{{ route('userAccountRoles') }}"
                    class="text-color-2 me-5 text-decoration-none fancy-link active"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    <h1 class="fs-1 text-uppercase">Account Creation</h1>
                </a>
            </div>
                        ...
                        <tbody>
                            @foreach($staffAccounts as $user)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $user->status === 'active' ? 'bg-success' : ($user->status === 'inactive' ? 'bg-danger' : '') }}">
                                            {{ ucfirst($user->status) }}
                                        </span>
                                    </td>
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm text-color-2" data-bs-toggle="modal"
                                            data-bs-target="#editUser{{ $user->id }}" title="Edit User">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#deleteUser{{ $user->id }}" title="Delete User">
