    ...
    <div class="container-fluid min-vh-100 d-flex p-0">
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex justify-content-center mb-5">
                <a href="{{ route('activityLogs') }}" class="text-color-2 text-decoration-none me-5 fancy-link active"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    <h1 class="fs-1 text-uppercase">Activity Logs</h1>
                </a>
                <a href="{{ route('userAccountRoles') }}" class="text-color-2 me-5 text-decoration-none fancy-link"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    ...
                    <form action="{{ route('activityLogs') }}" method="GET"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="input-group">
                                <input type="date" name="start_date" class="form-control"
                                    value="{{ request('start_date') }}" style="width: 150px; height: 38px;">
                                <span class="input-group-text" style="height: 38px;">to</span>
                                <input type="date" name="end_date" class="form-control"
                                    value="{{ request('end_date') }}" style="width: 150px; height: 38px;">
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <select name="role" class="form-select"
                                style="width: 150px; height: 38px; margin-top:-15px;">
                        ...
                        <div class="d-flex align-items-center flex-grow-1">
                            <div class="input-group">
                                <input type="search" name="search" class="form-control" placeholder="Search activity..."
                        ...
                        @if(request()->hasAny(['start_date', 'end_date', 'role', 'search']))
                            <div class="d-flex align-items-center">
                                <a href="{{ route('activityLogs') }}" class="btn btn-outline-secondary"
                                    style="height: 38px;">
