    ...
    <div class="container-fluid min-vh-100 d-flex p-0">
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="fw-semibold text-capitalize mt-4"
                    style="font-size: 50px; letter-spacing: 1px; color: #0b573d; margin-top: -30px; font-family: 'Anton', sans-serif; letter-spacing: .1em;">
                    Damage Report</h1>
            </div>
                            ...
                            <tr>
                                <td>
                                    @if($report->damage_photos)
                                        <img src="{{ asset('storage/' . $report->damage_photos) }}" alt="Damage Photo"
                                ...
                                <td>
                                    <span
                                        class="badge text-capitalize {{ $report->status == 'pending' ? 'bg-warning' : ($report->status == 'in progress' ? 'bg-info' : 'bg-success') }}">
                                        {{ $report->status }}
                                    </span>
                                </td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <button class="btn btn-sm color-background5 text-white rounded-3 shadow-sm"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content rounded-4" style="border: 2px solid #0b573d;">
                        <div class="modal-header color-background5 text-white rounded-top-4"
                            ...
                            <h5 class="modal-title fw-bold" style="font-family: 'Poppins', sans-serif;">Edit Damage Report
                            </h5>
