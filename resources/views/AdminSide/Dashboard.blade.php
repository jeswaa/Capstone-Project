    ...
    <div class="container-fluid min-vh-100 d-flex p-0">
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex align-items-center">
                <p class="text-color-1 fs-1 ms-4 mb-0" style="font-family: 'Anton', sans-serif; letter-spacing: 0.2em;">
                    Hello</p>
                <h1 class="fw-semibold text-capitalize ms-3 mb-0 fs-1"
                    style="letter-spacing: 1px; color: #0b573d; font-family: 'Anton', sans-serif; letter-spacing: 0.2em;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div
                                    class="color-background8 text-white rounded-4 p-3 d-flex justify-content-between align-items-center">
                                    <div>
                                ...
                                @if(count($latestReservations) > 0)
                                    @foreach ($latestReservations as $reservation)
                                        <li class="list-group-item d-flex justify-content-between mt-1">
                                            ...
                                            <small
                                                class="text-muted">{{ \Carbon\Carbon::parse($reservation->reservation_check_in_date)->format('M d') }}</small>
                                        </li>
                                    @endforeach
                                @else
                    ...
                    <div id="chartSection1" class="chart-section">
                        <div class="d-flex justify-content-between align-items-center mt-5">
                            <h1 class="text-color-1 font-paragraph fw-bold" style="font-size: 50px;">Reservation
                                Overview</h1>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="me-3 d-flex align-items-center">
                                    <label for="timeFilter"
                                        class="form-label mb-0 me-2 font-paragraph fw-semibold">Filter By:</label>
                                ...
                                <div class="d-flex align-items-center">
                                    <label for="yearFilter"
                                        class="form-label mb-0 me-2 font-paragraph fw-semibold">Year:</label>
                        ...
                        <div class="row g-0 mt-4">
                            ...
                            <div class="col-md-6 p-0 d-flex flex-column justify-content-start ms-3" style="width: 73%;">
                                <div class="shadow-lg rounded-4 p-3 bg-white floating-effect" style="height: 100%;">
                                    <canvas id="reservationChart" class="w-100" height="100"
