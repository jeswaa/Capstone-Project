...
<body
    ...
    <div class="container-fluid min-vh-100 d-flex p-0">
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <!-- CONTENT -->
            <div>
                <h1 class="text-uppercase mt-5 ms-3"
                    style="font-family: 'Anton', sans-serif; color: #0b573d; letter-spacing: 0.2em; font-size: 3rem;">
                                ...
                                <form action="{{ route('reports') }}" method="GET" id="monthYearForm">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div style="flex: 0 0 300px;">
                                            <label for="bookingMonth" class="form-label font-paragraph mb-2">Select
                                                Month & Year</label>
                                            <input type="month" class="form-control font-paragraph" id="bookingMonth"
                                                name="month_year" value="{{ request('month_year', date('Y-m')) }}">
                                        </div>
                                        <div>
                                            <button type="submit" class="btn btn-primary"
                                                style="height: 38px; width: 120px;">Apply Filter</button>
=======
...
>>>>>>> e7feac40c7fb2d9dcc6a9eec3e7fbbf774d09206
                            ...
                            <div class="col-md-3">
                                <div class="card shadow-sm h-100">
                                    <div class="card-header">
<<<<<<< HEAD
                                        <h6 class="card-title mb-0 font-paragraph fw-semibold">Guest Age Distribution
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <canvas id="guestsDistributionChart"></canvas>
...
<<<<<<< HEAD
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100">
                            <div class="card-header">
                                <h6 class="card-title mb-0 font-paragraph fw-semibold p-2">Early Checked-out Bookings
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="text-center">
    ...
    : 'Select a date and apply filter' }}
                                    ...
                                    <div class="badge bg-secondary">
                                        {{ number_format(($earlyCheckedOutCount / ($confirmedBookings ?: 1)) * 100, 1) }}%
                                        Early Check-out Rate
                                    </div>
                                </div>
                            </div>
                        </div>
