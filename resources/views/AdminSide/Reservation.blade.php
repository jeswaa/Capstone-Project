...
<<<<<<< HEAD
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('reservations') }}" class="text-color-2 text-decoration-none me-5 fancy-link active"
                ...
                <a href="{{ route('addActivities') }}" class="text-color-2 text-decoration-none fancy-link"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
            ...
            <div class="mt-5">
                ...
                <!-- Search Function -->
                <form class="d-flex justify-content-center align-items-center w-100 mb-3 mt-1" role="search"
                    id="filterForm">
                    <div class="input-group">
                        <input type="text" class="form-control mb-0 rounded-start-5 bg-light border border-secondary"
                            placeholder="Search Guest Name" aria-label="Search" id="guestNameFilter">
