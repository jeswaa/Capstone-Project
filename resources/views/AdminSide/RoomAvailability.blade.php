    ...
    <div class="container-fluid min-vh-100 d-flex p-0">
        ...
        <div class="col-md-3 col-lg-2 color-background8 text-white py-5 position-sticky" style="top: 0; height: 100vh;">
            <div class="d-flex flex-column align-items-center">
                <img src="{{ asset('images/default-profile.jpg') }}" alt="Profile Picture"
                    class="rounded-circle w-50 mb-3 border border-5 border-white">
                <p class="font-heading sidebar-text" data-bs-toggle="modal" data-bs-target="#editProfileModal"
                    style="cursor: pointer;">Edit Profile</p>
            </div>

            <div class="d-flex flex-column px-4 mt-4">
                <a href="{{ route('dashboard') }}"
                    class="text-white text-decoration-none py-2 d-flex align-items-center mt-4 text-underline-left-to-right">
        ...
        <div class="col-md-9 col-lg-10 py-4 px-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h1 class="fw-semibold fs-1"
                    style="font-family: 'Anton', sans-serif; color: #0b573d; letter-spacing: 0.2em;">ROOM</h1>
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('rooms') }}" class="text-color-2 me-5 text-decoration-none fancy-link active"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    <h1 class="fs-1 text-uppercase">Room </h1>
                </a>
                <a href="{{ route('packages') }}" class="text-color-2 text-decoration-none fancy-link"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">
                    <h1 class="fs-1 text-uppercase">Packages</h1>
                </a>
            </div>

            <div>
                <h1 class="text-color-2 fw-bold mt-3 ms-5"
                    style="font-family: 'Anton', sans-serif; letter-spacing: 0.1em;">Overview</h1>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="text-uppercase mb-1"
                                            style="font-family: Anton; letter-spacing: 0.1em;">Total Rooms</h5>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white rounded-4 shadow p-4" style="background-color: #0b573d;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="text-uppercase mb-1"
                                            style="font-family: Anton; letter-spacing: 0.1em;">Available Rooms</h5>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white rounded-4 shadow p-4" style="background-color: #0b573d;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="text-uppercase mb-1"
                                            style="font-family: Anton; letter-spacing: 0.1em;">Reserved Rooms</h5>
