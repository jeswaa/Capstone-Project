                                ...
                                <div class="col-md-6">
                                    <div class="card shadow-sm border-0" style="border-radius: 15px;">
                                        <div class="card-header bg-success text-white"
                                            style="background-color: #0b573d !important; border-radius: 15px 15px 0 0;">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <div>
                                                    ...
                                                    <p class="mb-0">
                                                        {{ date('F d, Y', strtotime($reservation->reservation_check_in_date)) }}
                                                    </p>
                                                </div>
                                                <div>
                                                    <h6 class="mb-1">Check-in Time:</h6>
                                                    <p class="mb-0">
                                                        {{ date('h:i A', strtotime($reservation->reservation_check_in)) }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <div>
                                                    ...
                                                    <p class="mb-0">
                                                        {{ $reservation->reservation_check_out_date ? date('F d, Y', strtotime($reservation->reservation_check_out_date)) : 'N/A' }}
                                                    </p>
                                                </div>
                                                <div>
                                                    <h6 class="mb-1">Check-out Time:</h6>
                                                    <p class="mb-0">
                                                        {{ date('h:i A', strtotime($reservation->reservation_check_out)) }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0">Adults: {{ $reservation->number_of_adults }} | Children:
                                                    {{ $reservation->number_of_children }}</p>
                                            </div>

                                            <div class="mb-3">
                                                <h6 class="mb-1">Status:</h6>
                                                <span
                                                    class="badge bg-{{ $reservation->reservation_status === 'pending' ? 'warning' : ($reservation->reservation_status === 'confirmed' ? 'success' : 'danger') }}">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="badge bg-success fs-6"
                                                    style="background-color: #0b573d !important;">
