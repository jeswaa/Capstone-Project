...
<body>
    ...
    <nav class="navbar navbar-expand-lg position-absolute top-0 w-100" style="z-index: 10;">
        <nav class="navbar navbar-expand-lg position-absolute top-0 w-100" style="z-index: 10;">
            <div class="container">
                ...
                <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="collapse"
                    ...
                    <!-- Logo - visible on all screens, aligned left -->
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('images/appicon.png') }}" alt="Lelo's Resort" id="logo" height="150"
                            width="130">
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end text-end mb-5" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link fw-semibold text-uppercase text-decoration-none" href="#about">About
                                    Us</a>
                                <a class="nav-link fw-semibold text-uppercase text-decoration-none" href="#about">About
                                    Us</a>
                            </li>
        ...
        <section>
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-lg-6 col-md-10 col-sm-12 text-lg-end text-center ms-auto">
                                <div class="d-flex justify-content-center align-items-center">
                                    <h1 class="fw-bold text-white" style="font-size: 3vw; text-align: center;">WELCOME
                                        TO LELO'S
                                    </h1>
                                    <h1 class="fw-bold text-white" style="font-size: 3vw; text-align: center;">WELCOME
                                        TO LELO'S
                                ...
                                <p class="fw-bold"
                                    ...
                                    RESORT</p>
                                <h1 class="fw-bold text-white" style="font-size: 2vw; text-align: center;">DIGITAL
                                    BOOKING
                                    COMPANION</h1>
                                <p class="fw-bold"
                                    style="color:#e9ffcc; font-size: 10vw; font-weight: 900; line-height: .8; text-align: center;">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="5000">
                                                <img src="{{ asset('images/image1.JPG') }}"
                                                    class="d-block w-100 rounded" alt="Hotel Image 1">
                                            </div>
                                            <div class="carousel-item" data-bs-interval="5000">
                                                <img src="{{ asset('images/image5.JPG') }}"
                                                    class="d-block w-100 rounded" alt="Hotel Image 2">
                                            </div>
                                            <div class="carousel-item" data-bs-interval="5000">
                                                <img src="{{ asset('images/image8.jpg') }}"
                                                    class="d-block w-100 rounded" alt="Hotel Image 3">
                                            </div>
                                            <div class="carousel-item" data-bs-interval="5000">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="mt-3 p-3 rounded-pill"
                                        ...
                                        <p class="text-success m-0" style="font-size: 1.1rem;">
                                            <em>Booking your stay is quick and easy with our simple reservation
                                                system!</em>
                                        </p>
                                    </div>
                                    <hr class="border-dark mx-auto" style="width: 80%;">
                            ...
                            <div class="p-4 h-100" style="background: #0b573d; border-radius: 10px;">
                                ...
                                <div class="map-container"
                                    ...
                                    <iframe
                                        ...
                                        width="100%" height="350" style="border: none;" allowfullscreen=""
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="p-4 h-100">
                                        <div class="d-flex flex-column h-100">
                                            <img src="{{ asset('images/appicon.png') }}" alt="Lelo's Resort Logo"
                                            ...
                                            <div class="text-start">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="p-4 h-100">
                                                        <div class="d-flex flex-column h-100">
                                                            <img src="{{ asset('images/appicon.png') }}"
                                                                alt="Lelo's Resort Logo" class="img-fluid mb-4"
                                                                style="height: 150px; width: auto; margin: -20px auto; display: block;">
                                                            ...
                                                            <div class="text-start">
                                                                ...
                                                                <div class="mb-4">
                                                                    <h5
                                                                        ...
                                                                        Our Story</h5>
                                                                    <p
                                                                        style="font-family: 'Montserrat', sans-serif; font-size: 1.2rem; color: #333;">
                                                                        Established in 2020, Lelo's Resort has been
                                                                        providing a serene mountain getaway
                                                                        experience for families and friends. Nestled in
                                                                        the heart of Nueva Ecija, our
                                                                        resorts offer stunning views, comfortable
                                                                        accommodations, and a perfect blend of
            ...
            <div class="mb-4">
                <h5 style="color: #0b573d; font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 1.8rem;">
                    Our Story</h5>
