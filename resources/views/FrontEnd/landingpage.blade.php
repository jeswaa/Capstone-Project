    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end text-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link fw-semibold text-uppercase text-decoration-none me-4" href="#home">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold text-uppercase text-decoration-none me-4" href="#about">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold text-uppercase text-decoration-none me-4" href="#reviews">Review</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="nav-link fw-semibold text-uppercase text-decoration-none me-4">Login</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container text-center my-5">
        <div class="py-5">
            <div class="position-relative">
                ...
                <div class="position-relative px-4 py-3 w-100" style="background-color: #E6F4E6; border-radius: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
...
<section>
    <div class="container text-center my-5">
        ...
        <div class="py-5 mt-5">
            <div class="position-relative px-4 py-3" style="background-color: #E6F4E6; border-radius: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                <h1 class="fw-bolder text-success display-5" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.1); font-weight: 900;">
                    ACTIVITIES
                </h1>
            </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-5">
                <div class="card h-100 shadow-sm border-0" style="border-radius: 20px; overflow: hidden;">
                    <div class="position-relative">
                        <img src="{{ asset('images/room1.jpg') }}" class="card-img-top" alt="Activity 1" style="border-radius: 20px 20px 0 0; height: 180px; object-fit: cover;">
                        <div class="position-absolute bottom-0 end-0 m-2 px-3 py-1 bg-success text-white fw-bold" style="border-radius: 8px; font-style: italic; font-size: 1.2rem;">
                            Nature Walk
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="card h-100 shadow-sm border-0" style="border-radius: 20px; overflow: hidden;">
                    <div class="position-relative">
                        <img src="{{ asset('images/campings.jpg') }}" class="card-img-top" alt="Camping" style="border-radius: 20px 20px 0 0; height: 180px; object-fit: cover;">
                        <div class="position-absolute bottom-0 end-0 m-2 px-3 py-1 bg-success text-white fw-bold" style="border-radius: 8px; font-style: italic; font-size: 1.2rem;">
                            Camping
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="card h-100 shadow-sm border-0" style="border-radius: 20px; overflow: hidden;">
                    <div class="position-relative">
                        <img src="{{ asset('images/DSCF2729.jpg') }}" class="card-img-top" alt="ATV" style="border-radius: 20px 20px 0 0; height: 180px; object-fit: cover;">
                        <div class="position-absolute bottom-0 end-0 m-2 px-3 py-1 bg-success text-white fw-bold" style="border-radius: 8px; font-style: italic; font-size: 1.2rem;">
                            ATV
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="card h-100 shadow-sm border-0" style="border-radius: 20px; overflow: hidden;">
                    <div class="position-relative">
                        <img src="{{ asset('images/swimming.jpg') }}" class="card-img-top" alt="Swimming" style="border-radius: 20px 20px 0 0; height: 180px; object-fit: cover;">
                        <div class="position-absolute bottom-0 end-0 m-2 px-3 py-1 bg-success text-white fw-bold" style="border-radius: 8px; font-style: italic; font-size: 1.2rem;">
                            Swimming
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 d-flex flex-column align-items-end text-white">
                <a href="https://www.facebook.com/lelosmountainresort" target="_blank" class="text-white d-flex align-items-center gap-2 mb-1">
