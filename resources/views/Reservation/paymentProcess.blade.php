...
<body class="bg-light font-paragraph">
    <div class="container mt-5 px-3">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="text-center fw-bold" style="color: #e9ffcc; font-size: 2.5rem; margin: 0 auto;">RESERVATION
                PAYMENT</h1>
        </div>
        ...
        <form id="paymentForm" action="{{ route('savePaymentProcess') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white p-3 shadow rounded-1 mx-auto d-flex flex-column flex-md-row g-0 mt-4"
                style="width: 90%;">
                <div class="w-100 w-md-50 bg-light p-3 text-white">
                    ...
                    <ul class="nav nav-tabs justify-content-center mb-3" id="paymentTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="gcash1-tab" data-bs-toggle="tab"
                                data-bs-target="#gcash1-content" type="button" role="tab" aria-controls="gcash1-content"
                                aria-selected="true" style="color: #0B5D3B; transition: all 0.3s ease;">
                                GCash 1
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="gcash2-tab" data-bs-toggle="tab"
                                data-bs-target="#gcash2-content" type="button" role="tab" aria-controls="gcash2-content"
                                aria-selected="false" style="color: #0B5D3B; transition: all 0.3s ease;">
                                GCash 2
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="gcash3-tab" data-bs-toggle="tab"
                                data-bs-target="#gcash3-content" type="button" role="tab" aria-controls="gcash3-content"
                                aria-selected="false" style="color: #0B5D3B; transition: all 0.3s ease;">
                                GCash 3
                            </button>
                        </li>
                        ...
                        <div class="tab-content" id="paymentTabContent">
                            <!-- GCash 1 Content -->
                            <div class="tab-pane fade show active" id="gcash1-content" role="tabpanel"
                                aria-labelledby="gcash1-tab">
                                <div class="d-flex flex-column align-items-center">
                                    <input class="form-check-input d-none" type="radio" name="payment_method"
                                        id="gcash1" value="gcash" checked>
                                    <div class="bg-secondary p-1 d-flex align-items-center justify-content-center rounded-2"
                                        style="width: 400px; height: 400px; background-image: url('{{ asset('images/logosheesh.png') }}'); background-size: cover; background-position: center;">
                                        <img src="{{ asset('images/qrcode.jpg') }}" alt="GCash QR Code 1"
                                    ...
                                    <div class="alert mt-3" role="alert"
                                        style="background-color: #0B5D3B; color: white;">
                                        ...
                                        <ul class="mb-0">
                                            ...
                                            <li>Required security deposit. "Follow up will be done after done the
                                                reservation"</li>
                            ...
                            <div class="tab-pane fade" id="gcash2-content" role="tabpanel" aria-labelledby="gcash2-tab">
                                <div class="d-flex flex-column align-items-center">
                                    <input class="form-check-input d-none" type="radio" name="payment_method" id="gcash"
                                        value="gcash">
                                    <div class="bg-secondary p-1 d-flex align-items-center justify-content-center rounded-2"
                                        style="width: 400px; height: 400px; background-image: url('{{ asset('images/logosheesh.png') }}'); background-size: cover; background-position: center;">
                                        <img src="{{ asset('images/qrcode.jpg') }}" alt="GCash QR Code 2"
                                            style="max-width: 80%; height: auto;">
                                    </div>
                                    <div class="text-center mt-3">
                                        <p class="fw-bold text-success mb-0">GCash Number:</p>
                            ...
                            <div class="tab-pane fade" id="gcash3-content" role="tabpanel" aria-labelledby="gcash3-tab">
                                <div class="d-flex flex-column align-items-center">
                                    <input class="form-check-input d-none" type="radio" name="payment_method"
                                        id="gcash3" value="gcash">
                                    <div class="bg-secondary p-1 d-flex align-items-center justify-content-center rounded-2"
                                        style="width: 400px; height: 400px; background-image: url('{{ asset('images/logosheesh.png') }}'); background-size: cover; background-position: center;">
                                        <img src="{{ asset('images/qrcode.jpg') }}" alt="GCash QR Code 3"
                                            style="max-width: 80%; height: auto;">
                                    </div>
                                    <div class="text-center mt-3">
                                        <p class="fw-bold text-success mb-0">GCash Number:</p>
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="d-flex justify-content-between ">
                            ...
                            <ul class="list-unstyled text-end" id="accommodation-list">
                                @foreach ($accomodations as $accomodation)
                                    ...
                                    @endphp
                                    <p>
                                        {{ $accomodation->accomodation_name }}({{$quantity}}x) -
                                        ₱{{ number_format(floatval($accomodation->accomodation_price) ?? 0, 2) }}
                                    </p>
                                @endforeach
                            </ul>
                        </div>
                        @if($totalEntranceFee > 0)
                            <div class="d-flex justify-content-between">
                                ...
                                <input type="text" class="form-control text-end bg-secondary-subtle border-0 w-75"
                                    value="₱{{ number_format($totalEntranceFee, 2) }}" readonly>
                            </div>
                        @endif
                        ...
                        @if (isset($reservationDetails->package_id))
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <input type="text" class="form-control text-end bg-secondary-subtle border-0"
                                    value="₱ {{ number_format($packageEntranceFee, 2) }}" readonly>
                            </div>
                        @endif
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <input type="text"
                                class="form-control text-center bg-secondary-subtle border-0 fw-bold fs-5"
                                id="amount-display" style="max-width: 150px;" value="₱{{ number_format($amount, 2) }}"
                                readonly>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <input type="text" id="downpayment-display"
                                class="form-control text-end bg-secondary-subtle border-0" style="max-width: 150px;"
                        ...
                        <div class="mt-3">
                            ...
                            <input type="file" class="form-control bg-secondary-subtle border-0" name="upload_payment"
                                id="upload_payment" accept="image/*" required>
                        </div>

                        <div class="mt-3">
                            <label class="fw-bold">Sender's Number</label>
                            <input type="number" class="form-control bg-secondary-subtle border-0" name="mobileNo"
                                id="mobileNo" value="{{ auth()->user() ? auth()->user()->mobileNo : '' }}"
                                placeholder="ex: 09xxxxxxxxx" readonly>
                        </div>

                        <div class="mt-3">
                            <label class="fw-bold">Reference Number</label>
                            <input type="number" class="form-control bg-secondary-subtle border-0" name="reference_num"
                                id="reference_num" placeholder="ex: 1100xx-xxx-xxx" required>
                        </div>

                        <div class="d-grid gap-2 mt-3">
                            <button class="submit-button" type="submit" data-bs-toggle="modal"
