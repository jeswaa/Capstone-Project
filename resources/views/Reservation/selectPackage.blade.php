        ...
        <form method="POST" action="{{ route('fixPackagesSelection') }}">
            ...
            <div>
                <label for="activities" class="text-white font-paragraph fw-semibold mb-3 ms-2 mt-4"
                    style="font-size: 1.5rem;">Activities <span style="font-size: 1rem;">(ALL INCLUDED)</span></label>
                <div class="container">
                    <div class="row">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card p-3 shadow-sm border-0">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select id="session" name="session" class="form-control"
                                                    ...
                                                    <option value="morning" {{ (isset($transactions->session) && $transactions->session == 'morning') ? 'selected' : '' }}>Morning
                                                        Session</option>
                                                    <option value="evening" {{ (isset($transactions->session) && $transactions->session == 'evening') ? 'selected' : '' }}>Evening
                                                        Session</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="card p-3 shadow-sm border-0 mt-2">
                                            ...
                                            <div class="row g-1">
                                                <div class="col-md-12"> {{-- Changed from col-md-6 to col-md-12 to make
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="date" id="check_out_date"
                                                        name="reservation_check_out_date" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card p-3 shadow-sm border-0">
                                            ...
                                            <textarea id="specialRequest" name="special_request" class="form-control"
