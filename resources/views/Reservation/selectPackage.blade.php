...
<body class="bg-light font-paragraph"
    style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('images/packagebg.jpg') }}') no-repeat center center fixed; background-size: cover;">
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('fixPackagesSelection') }}">
            ...
            <div class="d-flex justify-content-start mt-4 mb-3 ms-2">
                <button type="button" class="btn text-dark px-4" style="background-color: rgba(255, 255, 255, 0.9);"
                    id="proceedToPayment" data-bs-toggle="modal" data-bs-target="#reservationModal" disabled>
            ...
            <div class="col-md-12 d-flex flex-column">
                ...
                <!-- Activities Section -->
                <div>
                    <label for="activities" class="text-white font-paragraph fw-semibold mb-3 ms-2 mt-4"
                        style="font-size: 1.5rem;">Activities <span style="font-size: 1rem;">(ALL
                            INCLUDED)</span></label>
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="card rounded-3 w-100">
                                        ...
                                        <div class="d-none form-check">
                                            <input class="form-check-input" type="checkbox" id="activity{{ $activity->id }}"
                                                name="activity_id[]" value="{{ $activity->id }}" {{ old('activity_id') && in_array($activity->id, old('activity_id')) ? 'checked' : 'checked' }}>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="card p-3 shadow-sm border-0 mb-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="quantity">Number of Rooms:</label> {{-- Updated label
                                                    text
                                                    --}}
                                            ...
                                            <div class="card p-3 shadow-sm border-0">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" name="number_of_adults" id="number_of_adults"
                                                        class="form-control p-2" value="0"
                                                        oninput="calculateTotalGuest()">
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <label for="number_of_children">Children <small
                                                                style="font-size:10px;">(3 to 12 years
                                                                old):</small></label>
                                                    ...
                                                    <input type="number" name="number_of_children"
                                                        id="number_of_children" class="form-control p-2" value="0"
                                                        oninput="calculateTotalGuest()">
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card p-3 shadow-sm border-0">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select id="session" name="session" class="form-control"
                                                        onchange="updateSessionTimes()">
                                                        <option value="morning" {{ (isset($transactions->session) && $transactions->session == 'morning') ? 'selected' : '' }}>
                                                            Morning
                                                            Session</option>
                                                        <option value="evening" {{ (isset($transactions->session) && $transactions->session == 'evening') ? 'selected' : '' }}>
                                                            Evening
                                                            Session</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="card p-3 shadow-sm border-0 mt-2">
                                                ...
                                                <div class="row g-1">
                                                    <div class="col-md-12"> {{-- Changed from col-md-6 to col-md-12 to
                                                        make
                                                        date inputs full width within this card --}}
                                                        <label for="reservation_date">Check-in Date:</label>
                                                        <input type="date" id="reservation_date"
                                                            name="reservation_check_in_date" class="form-control"
                                                            required readonly>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="date" id="check_out_date"
                                                            name="reservation_check_out_date" class="form-control"
                                                            readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card p-3 shadow-sm border-0">
                                                ...
                                                <textarea id="specialRequest" name="special_request"
            ...
            <div class="modal fade" id="paymentBreakdownModal" tabindex="-1"
                aria-labelledby="paymentBreakdownModalLabel" aria-hidden="true">
