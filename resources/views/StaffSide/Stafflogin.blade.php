...
<head>
    ...
    <title>Lelo's Resort Staff Login</title>
            ...
            <div class="col-md-12 d-flex p-0">
                ...
                <div class="col-md-6 bg-white p-5">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="text-center text-uppercase font-heading mt-5 mx-auto" style="color: #008000; width: fit-content;">Staff Login</h2>
                    </div>
                    <form action="{{ route('staff.authenticate') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="username" class="mt-3 mb-3 font-heading">Username</label>
                            <input type="text" class="form-control @error('username') is-invalid @enderror font-paragraph" id="username" name="username" placeholder="staff123..." required>
                            @error('username')
