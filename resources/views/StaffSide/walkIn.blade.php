                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pe-4 border-end">
                                        ...
                                        <div class="card mb-4 border-success">
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    @if($kidTransaction)
                                                        <small class="text-muted" id="child_entrance_fee">Entrance Fee: ₱<span id="child_fee">{{ number_format($adultTransaction->entrance_fee, 2) }}</span></small>
                                                    @else
                                        ...
                                        <script>
                                            function calculateTotalGuests() {
                                                ...
                                                // Kunin ang selected session
                                                const sessionSelect = document.getElementById('session');
                                                const selectedSession = sessionSelect.options[sessionSelect.selectedIndex].value;
                                                
                                                // Set different fees based on session
                                                let adultFee = 0;
                                                let childFee = 0;
                                                
                                                if(selectedSession === 'Morning') {
                                                    adultFee = {{ $morning_adult_fee ?? 500 }};
                                                    childFee = {{ $morning_child_fee ?? 250 }};
                                                } else if(selectedSession === 'Evening') {
                                                    adultFee = {{ $evening_adult_fee ?? 600 }};
                                                    childFee = {{ $evening_child_fee ?? 300 }};
                                                }
                                    ...
                                    <div class="col-md-6 ps-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select border-success" id="room_type" name="accomodation_id" required onchange="updateAmount()">
                ...
                <table class="table table-hover table-striped ">
                    ...
                    @foreach($walkinGuest as $guest)
                            <tr>
                                ...
                                <td>{{ $guest->reservation_check_in_date }} - {{ $guest->reservation_check_out_date }}</td>
                                ...
                                <td>{{ $guest->reservation_status }}</td>
